...
namespace bio {
    ...
    class BIO_API BinaryIO {
      public:
         ...
         * @see readLE() for reading a Little Endian value
         */
        template <typename T> T read(const ByteOrder endian) {
            T v;
        ...
        void writeWChar2Byte(const std::u16string &input, ByteOrder endian,
                             bool nullTerminate);
        ...
        void writeWChar4Byte(const std::u32string &input, ByteOrder endian,
                             bool nullTerminate);
      ...
      protected:
        template <typename T> constexpr T swapOrderInternal(const T input) {
